...
use Ducal\DevTool\Commands\Abstracts\BaseMakeCommand;
...
class PackageCreateCommand extends BaseMakeCommand implements PromptsForMissingInput
{
    public function handle(): int
    {
        ...
        $this->components->info(
            sprintf('<info>Add</info> <comment>"ducal/%s": "*@dev"</comment> to composer.json then run <comment>composer update</comment> to install this package!', $package)
        );
